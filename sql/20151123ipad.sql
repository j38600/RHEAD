...
CREATE TABLE `indisponibilidades` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `militar_id` int(8) NOT NULL,
  `gdh_inicio` datetime NOT NULL,
  `gdh_fim` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `militar_id` (`militar_id`),
  CONSTRAINT `indisponibilidades_ibfk_2` FOREIGN KEY (`militar_id`) REFERENCES `militares` (`nim`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(775995,	'Paulo Manuel Pereira',	'Simões',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(840302,	'Daniel Alexandre Póvoa',	'Pereira',	'2015-01-01 01:00:00',	1200,	1,	8,	1,	2),
(1508298,	'Filipe Miguel da Costa Oliveira',	'Fonseca',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(1561291,	'Rui Jorge Rio',	'Santos',	'2015-01-01 01:00:00',	1000,	1,	9,	1,	2),
(1852598,	'Raúl Vicente',	'Pinheiro',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(2456105,	'José Alberto da Silva',	'Maia',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(2619096,	'Carlos Manuel Marques',	'Carrinho',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(2773402,	'João Carlos Simões',	'Paiva',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(3427305,	'Valdemar Tiago Ramos',	'Silva',	'2015-01-01 01:00:00',	1000,	1,	7,	1,	2),
(3892702,	'Luís Filipe Jorge',	'Oliveira',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(4088884,	'Carlos Manuel de Sousa',	'Narra',	'2014-12-31 01:00:00',	1000,	1,	10,	1,	2),
(4503909,	'Suzana Dalila Alomaya Marques',	'Tavares',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(4902988,	'António Alberto Noronha',	'Ribeiro',	'2015-01-01 01:00:00',	1000,	1,	9,	1,	2),
(5154995,	'Pedro Manuel Silva',	'Soares',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(5256093,	'Humberto Joaquim Curralo',	'Machado',	'2015-01-01 01:00:00',	1000,	1,	9,	1,	2),
(5723594,	'Rui Michel Palmeiro',	'Regino',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(5827805,	'Miguel Arcanjo Vieira',	'Castro',	'2015-01-01 01:00:00',	1000,	1,	7,	1,	2),
(6284503,	'PEdro Miguel Viana',	'Ribeiro',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(6542603,	'Rui Duarte da Costa',	'Macedo',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(6967788,	'José Alberto',	'Santos',	'2015-01-01 02:00:00',	1000,	1,	9,	1,	2),
(7048887,	'Arnaldo Paulo Silva',	'Pereira',	'2015-01-03 01:00:00',	1000,	1,	10,	1,	2),
(7079290,	'João Fernandes',	'Carvalho',	'2015-01-01 01:00:00',	1000,	1,	9,	1,	2),
(7149409,	'Hugo Emanuel Gonçalves',	'Cardoso',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(7310306,	'José Emanuel Correia',	'Ferreira',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
(8896285,	'Eusébio Fernandes',	'Ferreira',	'2015-01-02 01:00:00',	1000,	1,	10,	1,	2),
(9844391,	'Joaquim Filipe Moreira',	'Lopes',	'2015-01-01 01:00:00',	1000,	1,	9,	1,	2),
(9879805,	'Márcia Ribeiro',	'Silva',	'2015-01-01 01:00:00',	1000,	1,	8,	1,	2),
...
CREATE TABLE `militares_escalas` (
  `militares_id` int(8) NOT NULL,
  `escalas_id` int(11) NOT NULL,
  KEY `escalas_id` (`escalas_id`),
  KEY `militares_id` (`militares_id`),
  CONSTRAINT `militares_escalas_ibfk_4` FOREIGN KEY (`escalas_id`) REFERENCES `escalas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `militares_escalas_ibfk_6` FOREIGN KEY (`militares_id`) REFERENCES `militares` (`nim`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

INSERT INTO `militares_escalas` (`militares_id`, `escalas_id`) VALUES
(10528203,	1),
(10116702,	1),
(775995,	1);
...
(1,	'127.0.0.1',	'administrator',	'$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36',	'',	'admin@admin.com',	'',	NULL,	NULL,	NULL,	1268889823,	1448278349,	1,	'Admin',	'istrator',	'ADMIN',	'0');
